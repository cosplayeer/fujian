...
# PostObject = 'true'
# PostObject = 'ECMWF20190101'
# PostObject = 'ECMWF20190201'
PostObject = 'ECMWF20190301'
...
def datapandas():
    ...
    #}
    #mainECMWF_' + PostObject + 'ECnotgood.py
    #{
    inputfile1 = './data/' + PostObject + '/output_obs_origin_1.csv'
    inputfile2 = './data/' + PostObject + '/output_obs_origin_2.csv'
    inputfile3 = './data/' + PostObject + '/output_obs_origin_3.csv'
    inputfile4 = './data/' + PostObject + '/output_obs_origin_4.csv'
    inputfile_after = './data/' + PostObject + '/output_obs_prediction.csv'
    #}
     # origin 原来的3月份预报
    ...
    #data1['before'] = data1['before'] #- 1.2 # origin data as slow as ' + PostObject + ' predictors
...
def plotfigTimeSeriesSixtoOne(data_two, data_four):
    ...
    fig = ax.get_figure()
    fig.savefig('./plot/' + PostObject + '/TimeSeriesSixtoOne.png')
    fig.clf()
...
def plotfigbox(data_two):
    ...
    ax1 = s.hist()
    fig = ax1.get_figure()
    fig.savefig('./plot/' + PostObject + '/hist.png')
    fig.clf()
    
    s2 = data_two['after']
    ax1 = s2.hist()
    fig = ax1.get_figure()
    fig.savefig('./plot/' + PostObject + '/hist_after.png')
    fig.clf()
...
def dataoutput(data): 
    ...
    def pchip6h_output6h(data6h):
        data6h.to_csv('./data/' + PostObject + '/timeseries6hourly.csv', index = False, float_format="%.2f")
    def pchip6h_output1h(data1h):
        data1h.to_csv('./data/' + PostObject + '/timeseries1hourly.csv', index = False, float_format="%.2f")
